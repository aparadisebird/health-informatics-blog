        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-10">
          <div className="text-left">
            ...
            <div className="mt-10 flex gap-4">
              ...
              <Link href="/projects" className="px-8 py-3 bg-white border border-stone-200 text-stone-600 rounded-xl font-bold text-sm hover:border-teal-500 transition-all">
                Technical Projects
              </Link>
            </div>
          </div>
              ...
              >
                ...
                <div className="p-7 flex-1 flex flex-col">
                  ...
                  <div className="mt-auto pt-4 border-t border-slate-50 flex items-center justify-between">
                    <span className="text-teal-600 font-bold text-xs">Read Full Story →</span>
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-16 relative z-10">
          <div className="relative group">
            <div className="w-72 h-72 md:w-80 md:h-80 rounded-[3rem] overflow-hidden border-4 border-teal-400 shadow-2xl transform -rotate-3 group-hover:rotate-0 transition-all duration-500">
              <img src="https://i.postimg.cc/0jWxqG12/Chat-GPT-Image-Dec-17-2025-01-42-38-PM.png" className="w-full h-full object-cover" alt="Shifat Shahriar Siam" />
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
            ...
            <div>
              ...
              <ul className="space-y-4 text-slate-300 font-bold text-sm uppercase tracking-wide">
                ...
                <li><Link href="/projects" className="hover:text-teal-400 transition-colors">Technical Projects</Link></li>
          ...
          <div className="pt-10 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div className="flex gap-8">
              ...
              <a href="https://linkedin.com/company/the-health-nexus-bd" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-teal-400 transition-colors text-xs font-bold uppercase tracking-widest">LinkedIn</a>
            </div>
          </div>
        </div>
      </footer>
